...
if __name__ == "__main__":
    filename = "/Users/kevin/Desktop/program files/MeachineLearning/ClassicalMeachineLearn/Exercises/k邻近算法/海伦约会/data.txt"
    returnMat, labels = file2matrix(filename)
    showdatas(returnMat, labels)