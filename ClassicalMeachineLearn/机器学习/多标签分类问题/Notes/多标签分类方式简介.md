...
目前主流的算法包括**ML-KNN、ML-DT、Rank-SVM、CML**等，其中ML-[KNN算法](https://so.csdn.net/so/search?q=KNN算法&spm=1001.2101.3001.7020)思想最简单，最朴素。 ML-KNN借鉴了KNN的思想寻找K个近邻样本，并运用贝叶斯条件概率，来计算当前标签为1和0的概率，概率大的标签定为样本最终的标签。
...
链接：https://pan.baidu.com/s/1WFS7LHBphQA0qEC6HPgsKA
