# [Python实现聚类算法总结](https://www.cnblogs.com/lc1217/p/6963687.html)
...
**6.DBSCAN**
    ...
    b）主要参数（[详细参数](http://scikit-learn.org/dev/modules/generated/sklearn.cluster.DBSCAN.html#sklearn.cluster.DBSCAN)）
